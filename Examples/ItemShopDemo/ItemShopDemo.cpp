// ItemShopDemo.cpp : 定义应用程序的入口点。
//

#include "stdafx.h"
#include "ItemShopDemo.h"
#include "KeepAlive.h"
#include "Window.h"
#include "Manager.h"
...
ItemsDisplayWindow* pItemwindow;
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_ITEMSHOPDEMO, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_ITEMSHOPDEMO));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_ITEMSHOPDEMO));
	wcex.hCursor		= 0;
